...
// events. The pathCounter value is appended to the last_pageview_path and
// this_pageview_path Tracks event props.
let pathCounter = 0;
...
const analytics = {
	...
	pageView: {
		record: function( urlPath, pageTitle, params = {} ) {
			...
			setTimeout( () => {
				params.last_pageview_path = mostRecentUrlPath + '(' + pathCounter.toString() + ')';
				pathCounter++;
				params.this_pageview_path = urlPath + '(' + pathCounter.toString() + ')';
